...
public class insert_artist extends HttpServlet{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    writer.write("<html>\n");
    writer.write("<head><title>Insert Artist</title></head>\n");
    writer.write("<body>\n");
    writer.write("<center>\n");
    ...
    writer.write("<ul>\n");
    writer.write("<li>Artist name: <em>"+name+"</em>\n");
    writer.write("</ul>\n");
    writer.write("<hr style=\"margin-left:5em; margin-right:5em\">\n");
    ...
    try{
      ...
      ResultSet result = null;
       ...
       result = statement.executeQuery("SELECT name FROM artist WHERE name =" +name);
       ...
       else
       {
          ...
          String insert_sql_stmt = "INSERT INTO artist VALUES('null', '"+name+"')";
        ...
        exc.printStackTrace();
        printMsg(exc.toString(), writer, request);
      }
}
  ...
  private void printMsg(String msg, PrintWriter writer, HttpServletRequest request){
    ...
    writer.write("<hr style=\"margin-left:5em; margin-right:5em\">\n");
    writer.write("<center>\n");
    writer.write("<a href = \"insert_artist.html\">Back</a>\n");
    writer.write("</center>\n");
    writer.write("</body>\n");
    writer.write("</html>\n");
  }
